...
The Upload form allows information entered and [downloaded](7mr4.md) at one workstation to be transferred to another. It provides users that do not have network access the ability to maintain a [centralized database](readme/7d0y/7mnk/). To bring up the Upload form select the Administrator - Upload menu item on the [main form](7jjr.md).
