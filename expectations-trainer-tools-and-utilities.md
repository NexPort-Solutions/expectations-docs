...
The Signatures tab will appear in the Evaluation Reviewer to allow an evaluation to be signed by the reviewer when the "Allow completed evaluations to be signed before they are fully-reviewed" checkbox is checked (in the [Signatures](expectations-trainer-tools-and-utilities.md#broke-1664s55.md) sub-tab of the [System Utilities](expectations-trainer-tools-and-utilities.md#broke-2xcytpi.md) form's [Global Settings](expectations-trainer-tools-and-utilities.md#broke-46r0co2.md) tab).
...
* [Evaluations by Trainer/Supervisor](expectations-trainer-tools-and-utilities.md#broke-43ky6rz.md)
* [Evaluations by Trainee/Employee](expectations-trainer-tools-and-utilities.md#broke-1egqt2p.md)
* [Criteria Sets](expectations-trainer-tools-and-utilities.md#broke-2zbgiuw.md)
* [System Tables](expectations-trainer-tools-and-utilities.md#broke-3l18frh.md)
